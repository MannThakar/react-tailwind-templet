        ...
        (currentStep?.stepNumber === 1 ? (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mt-10 text-[12px]">
              ...
              <div>
                <h5 className="text-black text-sm pb-1">Last Name</h5>
                <input
                  type="text"
                  placeholder="eg. Doe"
                  className="w-full h-12 px-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                <h5 className="text-black text-sm pb-1">Date Of Birth</h5>
                <input
                  type="text"
              ...
              <div>
                <h5 className="text-black text-sm pb-1">Email Address</h5>
                <input
                  type="email"
              ...
              <div className="col-span-2">
                <h5 className="text-black text-sm pb-1">Address</h5>
                <input
                  type="text"
          ...
          >
            ...
            <div className="mt-14">
              <h5 className="text-black text-sm pb-1">Message</h5>
              <textarea
